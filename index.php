...
<html lang="es">
    ...
    <body>
        <div class="header">
            <h1><font color="red"> Denuncias:  3415170039 <br> JHON ALEXANDER DURAN LASERNA</font></h1>
                        <h3>Aplicación web para el registro de denuncias del transporte publico en Colombia</h3> 
            <h3>Permite el control y la veduría pública </h3>
        </div>
        <div class="seccion">
            <h3><font color="red">Registre aquí sus denuncias</font></h3>
        ...
        <div class="footer">
          <h1>  Realizado por: JADL - U.CALDAS</h1>
        </div>
    </body>
</html>